...
public class JsonLibTest {
	 ...
	 * 
	 * 1.JSONObject是一个name:values集合，通过它的get(key)方法取得的是key后对应的value部分(字符串) 通过它的getJSONObject(key)可以取到一个JSONObject，--> 转换成map, 通过它的getJSONArray(key) 可以取到一个JSONArray ，
	 */
	...
	public void testJSONToBeanHavaMap() {
		...
		/*
		 * 输出: 　　　　　　　　{testOne=net.sf.ezmorph.bean.MorphDynaBean@f73c1[ 　　　　　　　　 {name=test1} 　　　　　　　　], testTwo=net.sf.ezmorph.bean.MorphDynaBean@186c6b2[ 　　　　　　　　 {name=test2} 　　　　　　　　]} 　　　　　　
		 */
