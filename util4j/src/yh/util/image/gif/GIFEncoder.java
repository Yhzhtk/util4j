 ...
 * HREF="http://www.dcs.ed.ac.uk/%7Emxr/gfx/">Graphics Interchange Format</A>). A GIFEncoder is constructed with either
 * an AWT Image (which must be fully loaded) or a set of RGB arrays. The image can be written out with a call to
 * <CODE>Write</CODE>.
 * <P>
 * 
 * Three caveats:
 ...
 * algorithm, see Graphics Gems II III.2 by Xialoin Wu. Or check out his <A
...
public class GIFEncoder {
	 ...
	 *                Will be thrown if the pixel grab fails. This can happen if Java runs out of memory. It may also
	 *                indicate that the image contains more than 256 colors.
	 * */
